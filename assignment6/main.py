...
def convolve_1(input_params, kernel_params, num_channels, hyperparams): 
    filters = 
...
output, time_taken = convolve_naive(input_params, kernel_params, num_channels,hyperparams)
